...
from phm.sources.rdap.adapter import RDAPAdapter
from phm.sources.ssl.adapter import SSLAdapter
from phm.sources.wayback.adapter import WaybackAdapter
from phm.sources.whois.adapter import WhoisAdapter
...
class TechnicalIntelligencePlugin(BasePlugin):
    ...
    plugins during normal runs. Invoke explicitly with:
        ...
        phm technical example.com --plugin technical_intelligence
    """
