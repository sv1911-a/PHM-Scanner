"""Target auto-detection for `phm analyze`.

Detection should be transparent. PHM scores multiple possible meanings,
...
from phm.sources.github.adapter import parse_repo_slug
