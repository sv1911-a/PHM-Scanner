"""SQLite investigation storage for PHM."""
...
from phm.core.models import InvestigationReport, to_primitive
...
class InvestigationStore:
    ...
    def __init__(self, db_path: str | Path = "investigations/phm.db") -> None:
