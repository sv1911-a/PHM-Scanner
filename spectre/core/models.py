"""Shared data models for SPECTRE.

SPECTRE is a self-contained cybersecurity analysis framework. These models are
...
class Category(str, Enum):
    """Top-level SPECTRE capability categories.
...
class Severity(str, Enum):
    ...
    SPECTRE is not only a vulnerability scanner; this is used as a generic
...
class InvestigationReport:
    """Aggregated report for a SPECTRE run."""
