...
from spectre.core.models import Category, Detection, Finding, PluginResult, TargetContext
...
class BasePlugin(ABC):
    """Base contract every SPECTRE plugin must expose.

    All capabilities in SPECTRE are plugins. Each plugin must implement the
